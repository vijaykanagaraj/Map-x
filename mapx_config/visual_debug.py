...
from .pre_processing import find_boxes_preprocessing , find_paragraph_preprocessing , convert_pdf_to_image , find_vertical_lines, find_horizontal_lines
...
def visual_debug(basic_info:BasicInformation):
    ...
    if basic_info.default_config.Extraction_settings.kind in ("PARAGRAPH","ALL") or (basic_info.default_config.Extraction_settings.kind in ("TABLE","ALL") and basic_info.default_config.Extraction_settings.check_for_table_in_paragraph):
        if basic_info.default_config.Extraction_settings.default_strategy in ("pdfplumber","camelot"):
            ...
            vertical_lines_image = find_horizontal_lines(basic_info)
